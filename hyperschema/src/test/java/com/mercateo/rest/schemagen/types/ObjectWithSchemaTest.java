...
public class ObjectWithSchemaTest {
    ...
    public void shouldDeserialize() throws Exception {
        ...
        Assertions.assertThat(objectWithSchema.getObject().value).isEqualTo("foo");
        Assertions.assertThat(objectWithSchema.getSchema().getLinks()).isEmpty();
        Assertions.assertThat(objectWithSchema.getMessages()).isEmpty();
    }
}