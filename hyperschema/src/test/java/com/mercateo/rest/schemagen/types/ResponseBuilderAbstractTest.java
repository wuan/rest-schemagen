...
public class ResponseBuilderAbstractTest {
    ...
    public void elementMapperShouldMapValueAndAddLink() {
        ...
        Assertions.assertThat(result.object.object).isEqualTo(value);
        Assertions.assertThat(result.object.schema.getLinks()).containsExactly(link3);
    }
    ...
    public void shouldCollectListOfOptionalContainerLinks() {
        ...
        Assertions.assertThat(result.schema.getLinks()).containsExactly(link1, link2);
    }
