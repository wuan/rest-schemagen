...
import com.mercateo.rest.schemagen.link.helper.BaseUriCreator;
...
public class LinkFactoryContextFactoryTest {
    ...
    public void shouldProvideLinkFactoryContext() throws Exception {
        ...
        Assertions.assertThat(linkFactoryContext.getBaseUri()).isEqualTo(baseUri);
        Assertions.assertThat(linkFactoryContext.getMethodCheckerForLink()).isEqualTo(methodCheckerForLink);
        Assertions.assertThat(linkFactoryContext.getFieldCheckerForSchema()).isEqualTo(fieldCheckerForSchema);
    }
}